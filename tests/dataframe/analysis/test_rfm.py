...
class TestRFMConfig:
    ...
    def test_default_config(self):
        ...
        config = RFMConfig(user_id_col='user_id', date_col='date', revenue_col='revenue')
...
class TestRFMAnalyzer:
    ...
    def test_different_score_bins(self, sample_transactions):
    ...
    def test_visualization_options(self, sample_transactions):
        """Test different visualization options"""
        analyzer = RFMAnalyzer(sample_transactions)
        for viz in [
            ['hist'], ['heat'], ['heat_pairs'], ['heat_sliced'], ['bar_sliced'], 
            ['scatter_sliced'], ['distr_grid'], ['seg_bar'], ['seg_tree']]:
            result = analyzer.rfm(
                user_id_col='user_id',
                date_col='date',
                revenue_col='revenue',
    ...
    @pytest.mark.parametrize("plots", [['hist'], ['heat'], ['heat_pairs'], ['heat_sliced'], ['bar_sliced'], 
                                        ['scatter_sliced'], ['distr_grid'], ['seg_bar'], ['seg_tree']])
