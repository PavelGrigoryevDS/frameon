"""
Plotting utilities for creating various types of visualizations.

Provides builders and functions for:
- Bar, line and area charts
- Distribution plots (boxplots, violin plots)
- Categorical comparisons
- Heatmaps and histograms
- Specialized plots like word clouds and parallel categories
"""
