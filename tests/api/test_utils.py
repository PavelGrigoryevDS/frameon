...
class TestAnalyzeJoinKeys:
    ...
    def test_composite_keys(self):
        ...
        df1 = pd.DataFrame(
            {"id1": [1, 2, 3], "id2": ["a", "b", "c"], "value": [10, 20, 30]}
        )
        df2 = pd.DataFrame(
            {"id1": [2, 3, 4], "id2": ["b", "c", "d"], "value": [200, 300, 400]}
        )
...
class TestFindInconsistentMappings:
    ...
    def test_consistent_mappings(self):
        ...
        df = pd.DataFrame(
            {"id": [1, 1, 2, 2, 3, 3], "value": ["a", "a", "b", "b", "c", "c"]}
        )
    ...
    def test_inconsistent_mappings(self):
        ...
        df = pd.DataFrame(
            {"id": [1, 1, 2, 2, 3, 3], "value": ["a", "b", "b", "b", "c", "d"]}
        )
    ...
    def test_no_inconsistencies(self):
        ...
        df = pd.DataFrame({"id": [1, 1, 2, 2], "value": ["a", "a", "b", "b"]})
    ...
    def test_return_summary_mode(self):
        ...
        result = find_inconsistent_mappings(
            df, "id", "value", return_summary=True, verbose=False
        )
...
class TestHaversineVectorized:
    ...
    def test_antipodal_points(self):
        ...
        assert (
            pytest.approx(distance, rel=0.01) == 20015
