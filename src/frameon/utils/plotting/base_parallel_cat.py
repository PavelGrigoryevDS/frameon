"""
Parallel categories visualization utilities.

This module provides tools for creating parallel categories plots (parallel sets)
with category filtering, color mapping, and automatic sorting by frequency.
...
def parallel_categories(
    ...
    fig = px.parallel_categories(
        ...
        color_continuous_scale=(
            color_scale if (color_mapping or len(categories) > 1) else None
        ),
