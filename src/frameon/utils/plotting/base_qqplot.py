"""
Quantile-Quantile (Q-Q) plot visualization utilities.

This module provides tools for creating Q-Q plots to compare sample distributions
to theoretical distributions. Includes skewness and kurtosis statistics display.
"""
...
def create_qqplot(
    ...
    fig = sm_qqplot(x, line=reference_line, fit=True)
